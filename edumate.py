...
def welcome_page(student_info): 
    ...
    #photo = PhotoImage(file="vai.jpg") # opening left side image - Note: If image is in same folder then no need to mention the full path 
    ...
    #photo1 = PhotoImage(file="download1.jpg") # opening right side image - Note: If image is in same folder then no need to mention the full path 
